    ...
    <div id="team" className="azzle-section-padding3 bg-heading">
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="col-xl-4 col-lg-6 col-md-6">
            <div className="azzle-iconbox-wrap2" data-aos="fade-up" data-aos-delay="400" style={{ backgroundColor: "rgba(198, 167, 100, 0.1)", padding: "30px", borderRadius: "12px", border: "1px solid rgba(198, 167, 100, 0.2)" }}>
              <div className="azzle-iconbox-rating" style={{ color: "var(--accent-color)", fontSize: "18px", marginBottom: "15px", letterSpacing: "2px" }}>
                {renderStars(5)}
              </div>
              <div className="azzle-iconbox-content2">
          ...
          <div className="col-xl-4 col-lg-6 col-md-6">
            <div className="azzle-iconbox-wrap2" data-aos="fade-up" data-aos-delay="600" style={{ backgroundColor: "rgba(198, 167, 100, 0.1)", padding: "30px", borderRadius: "12px", border: "1px solid rgba(198, 167, 100, 0.2)" }}>
              <div className="azzle-iconbox-rating" style={{ color: "var(--accent-color)", fontSize: "18px", marginBottom: "15px", letterSpacing: "2px" }}>
                {renderStars(5)}
              </div>
              <div className="azzle-iconbox-content2">

  ...
  const features: FeatureDetails[] = [
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" viewBox="0 0 70 70" fill="none">
          <path fillRule="evenodd" clipRule="evenodd" d="M35 8.70058L23.3333 0V23.3333H0L8.70058 35L1.01993e-06 46.6665H23.3333V23.3333H36.6665V0L35 8.70058ZM61.2994 35L70 23.3334H36.6665V46.6665H23.3333V70L35 61.2994L46.6665 70V46.6665H70L61.2994 35Z" fill="#10316B" />
        </svg>
      )
    },
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" viewBox="0 0 70 70" fill="none">
          <g clipPath="url(#clip0_1_4318)">
            <path d="M54.6224 50.3776L39.2444 35L54.6224 19.6223L70 35L54.6224 50.3776ZM15.3777 50.3776L0 35L15.3777 19.6223L30.7555 35L15.3777 50.3776ZM35 70L19.6223 54.6224L35 39.2444L50.3776 54.6224L35 70ZM35 30.7555L19.6223 15.3777L35 0L50.3776 15.3777L35 30.7555Z" fill="#10316B" />
          </g>
          <defs>
              ...
              <div key={index} className={`azzle-iconbox-wrap ${index === 3 ? 'wrap2' : ''}`}>
                ...
                <div className="azzle-iconbox-button mt-50">
                  <button 
                    ...
                    onMouseEnter={(e) => {
                      e.currentTarget.style.background = '#10316B';
                      e.currentTarget.style.color = '#fff';
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.background = '#FDBE34';
                      e.currentTarget.style.color = '#10316B';
                    }}
                  >
                    Read more
                  </button>
        ...
        >
          ...
          <div style={{ padding: '40px' }}>
            <div style={{ display: 'flex', alignItems: 'center', marginBottom: '30px' }}>
              ...
              <h2 style={{ margin: 0, color: '#10316B', fontSize: '32px' }}>{selectedFeature.title}</h2>
            </div>
            <p style={{ 
              fontSize: '16px', 
              lineHeight: '1.8', 
